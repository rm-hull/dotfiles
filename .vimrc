...
let tlist_clojure_settings = 'clojure;f:function;d:definition;p:protocol;n:namespace;m:macro;i:inline;a:multimethod definition;b:multimethod instance;c:definition (once);s:struct;v:intern'
